...
@section('content')
    ...
    <div class="col-xl-8 col-md-6">
        <div class="card">
            <form action="/pimpinan/gaji-karyawan-update/{{ $ListData->id }}" class="row g-2 m-2" method="POST">
                @csrf
                @method('PUT')
                <div class="col-md-6">
                    <label for="kode_gaji_karyawan" class="form-label">Kode Gaji<span class="text-danger">*</span></label>
                    <input type="kode_gaji_karyawan" class="form-control" id="kode_gaji_karyawan" name="kode_gaji_karyawan"
                        value="{{ $ListData->kode_gaji_karyawan }}" required readonly>
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <select class="form-select" name="id_karyawan" id="id_karyawan" required>
                        ...
                        <option value="{{ $ListData->id_karyawan }}" selected>
                            {{ $ListData->karyawan->fullname }}({{ $ListData->karyawan->position }})</option>
                ...
                <div class="col-md-6">
                    ...
                    <input type="month" class="form-control" id="month" name="month"
                        placeholder="Jumlah liter yang di beli" value="{{ $ListData->month }}" required>
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" id="total_gaji" name="total_gaji" placeholder="Total Gaji"
                        value="{{ $ListData->total_gaji }}" required readonly>
                </div>
