...
@section('title', 'Tambah data BOP BBM')
        ...
        <div class="card">
            <form action="{{ route('bbm-multiple-save') }}" method="post">
                ...
                <div class="col-12 p-2">
                    <button type="submit" class="btn btn-primary  mb-1 save" id="save"><i
                            class="fa-regular fa-floppy-disk"></i>
                        Simpan</button>
                    <a href="/pimpinan/bbm" class="btn btn-warning mb-1"><i class="fa-solid fa-rotate-left"></i> Kembali</a>
                </div>
            </form>
        </div>
    </div>
